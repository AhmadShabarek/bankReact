        ...
        <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px=6`}>
                ...
                <div className="flex flex-row justify-between items-center w-full">
                    <h1 className="flex-1 font-poppins font-semibold ss:text-[62px] text-[42px] text-white ss:leading-[90px] leading-[65px]">
                ...
                <h1 className="font-poppins font-semibold ss:text-[58px] text-[42px] text-white ss:leading-[90px] leading-[65px] w-full">
                    Payment Method.
                </h1>
            ...
            <div className={`flex-1 flex ${styles.flexCenter} md: my-0 my-10 relative`}>
                ...
                <div className="absolute z-[0] w-[40%] h-[100%] top-0 rounded-full pink__gradient"/>
                <div className="absolute z-[1] w-[70%] h-[70%] rounded-full bottom-40 white__gradient"/>
                <div className="absolute z-[0] w-[50%] h-[100%] right-20 rounded-full bottom-20 blue__gradient"/>
            </div>
